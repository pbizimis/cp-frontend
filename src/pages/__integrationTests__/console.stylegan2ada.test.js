...
import {
  fireEvent, getByAltText, render, screen, waitFor,
...
const server = setupServer(
  ...
  rest.get('http://localhost:8000/api/v1/user/images', (req, res, ctx) => res(
    ctx.json(fakeImageData),
  )),
  rest.post('http://localhost:8000/api/v1/stylegan2ada/stylemix', (req, res, ctx) => res(
    ctx.json({
